...
Я хочу рассказать как пришел к активному использованию фиче-флагов в разработке и какие задачи этим решаю. Доклад основывается на моем опыте и опыте моей команды из нескольких десятков JS разработчиков за несколько лет.
