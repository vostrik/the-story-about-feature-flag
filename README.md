...
## Слайд 5. Что такое ФФ и какую задачу они решают
...
## Слайд 6. High Level Architecture

Было: KSC MMC
Стало: KSC Web Console

## Слайд 7. Задача 3: быстрые релизы
...
## Слайд 8. Задача 2: распределенная разработка
...
## Слайд 9. Задача 1: деплоймент в разные среды
...
## Слайд 10. Задача 4: миграция кодовой базы
...
## Слайд 11. Задача 5: поставка трех продуктов из единой кодовой базы
...
## Слайд 12. Стандартные библиотеки и подходы
